...
export const questions = [
  {
    ...
    correctAnswer: 1,
    explanation: "A variable is a container (storage area) for holding data. The value of a variable can be changed throughout the program."
  },
  {
    id: 2,
    moduleId: 1,
    ...
    correctAnswer: 2,
    explanation: "String is a primitive data type in most programming languages, along with numbers, booleans, etc."
  },
  {
    id: 3,
    moduleId: 1,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: "Comments are used to explain code and make it more readable. They are ignored by the compiler/interpreter."
  },
  {
    id: 6,
    moduleId: 1,
    ...
    correctAnswer: 1,
    explanation: "Debugging is the process of finding and resolving defects or problems within a program."
  },
  {
    id: 7,
    moduleId: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "= is the assignment operator used to assign values, while == is the comparison operator used to compare values."
  },
  {
    id: 9,
    moduleId: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "Indentation is used to improve code readability and to show the structure of the code, especially in nested blocks."
  },
  {
    id: 11,
    moduleId: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "The CSS box model is a layout system that describes how elements are structured with margins, borders, padding, and content."
  },
  {
    id: 16,
    moduleId: 2,
    ...
    correctAnswer: 1,
    explanation: "The <head> tag contains metadata about the HTML document, including title, character set, styles, scripts, and other meta information."
  },
  {
    id: 17,
    moduleId: 2,
    ...
    correctAnswer: 1,
    explanation: "CSS selectors are patterns used to select and style HTML elements on a web page."
  },
  {
    id: 18,
    moduleId: 2,
    ...
    correctAnswer: 2,
    explanation: "The Document Object Model (DOM) is a programming interface that represents the structure of HTML and XML documents as a tree-like hierarchy."
  },
  {
    id: 19,
    moduleId: 2,
    ...
    correctAnswer: 1,
    explanation: "An event listener is a function that waits for a specific event (like clicks or key presses) to occur and then executes code in response."
  },
  {
    id: 20,
    moduleId: 2,
    ...
    correctAnswer: 1,
    explanation: "Media queries are used in CSS to apply different styles based on device characteristics like screen size, making websites responsive."
  },
  {
    id: 21,
    moduleId: 3,
    ...
    correctAnswer: 1,
    explanation: "An array is a data structure that stores elements in contiguous memory locations, allowing for direct access to any element using its index."
  },
  {
    id: 22,
    moduleId: 3,
    ...
    correctAnswer: 1,
    explanation: "A stack is a Last In First Out (LIFO) data structure where elements are added and removed from the same end."
  },
  {
    id: 23,
    moduleId: 3,
    ...
    correctAnswer: 2,
    explanation: "A queue is a First In First Out (FIFO) data structure where elements are added at one end and removed from the other end."
  },
  {
    id: 24,
    moduleId: 3,
    ...
    correctAnswer: 1,
    explanation: "A linked list is a data structure where elements (nodes) are connected through references, with each node containing data and a reference to the next node."
  },
  {
    id: 25,
    moduleId: 3,
    ...
    correctAnswer: 2,
    explanation: "A binary tree is a hierarchical data structure where each node has at most two children, referred to as left and right child nodes."
  },
  {
    id: 26,
    moduleId: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "A graph is a non-linear data structure consisting of vertices (nodes) and edges that connect these vertices."
  },
  {
    id: 28,
    moduleId: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "A heap is a specialized tree-based data structure that satisfies the heap property, commonly used to implement priority queues."
  },
  {
    id: 30,
    moduleId: 3,
    ...
    correctAnswer: 1,
    explanation: "Breadth-First Search (BFS) uses a queue to explore nodes level by level, while Depth-First Search (DFS) uses a stack to explore as far as possible along each branch."
  }
];
